...
@WebServlet(urlPatterns= {"/ServletTest", "/kbs.mbc", "/good"})	// 다중으로 걸 수 있다.
public class ServletTest extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("이렇게 적으면 서버 컴의 출력 장치로 출력: " + result);
		
		// 별도로 작성한 클래스 멤버 호출
		//ServletTest2 test2 = new ServletTest2("홍길동");	// 객체가 요청할 때마다 생성되므로 메모리 낭비가 심하다. 1회만 수행될 수 있도록 해야함.
		...
		System.out.println("현재 실행 중인 스레드 명: " + threadName);
