...
public class BoardManager {
	...
	public ArrayList<BoardDto> getDataAll(int page, String searchType, String searchWord){	// 검색이 있는 경우
	...
	public void updateReadcnt(String num) {	// 글 ㅐㄴ용 읽기 전에 조회수 증가
	...
	public void updateOnum(int gnum, int onum) {
		// 같은 그룹의 레코드는 모두 작업에 참여해 onum값 변경
